...
export const Carousel = (): FunctionComponent=> {
    ...
    return (
        <div className='h-[780px] w-full m-auto py-0 px-4 relative group'>
            ...
            <button type="button" onClick={0} className="absolute w-[200px] h-20 top-[90%] left-[50%] -translate-x-[50%] translate-y-[-50%] text-2xl rounded-3xl bg-white/70 hover:bg-white text-black border-black">Find your dream job NOW</button> 
        </div>
    );
}